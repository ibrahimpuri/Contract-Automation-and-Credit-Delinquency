...
models = {
    ...
    'XGBoost': XGBClassifier(n_estimators=50, learning_rate=0.1, max_depth=3, scale_pos_weight=(y_train.value_counts()[0] / y_train.value_counts()[1]), random_state=42)
}
...
voting_clf = VotingClassifier(estimators=[
    ...
    ('xgb', XGBClassifier(n_estimators=50, learning_rate=0.1, max_depth=3, scale_pos_weight=(y_train.value_counts()[0] / y_train.value_counts()[1]), random_state=42))
...
new_input = pd.DataFrame({
    ...
    'interest_paid': [1000]  # Ensure this feature matches the engineered features
})

# Apply the same scaler to new input
